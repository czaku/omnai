...
All notable changes to omnai are documented in this file.
...
- Config file support (~/.omnai.conf)
...
[Unreleased]: https://github.com/czaku/omnai/compare/v1.0.0-rc2...HEAD
[v1.0.0-rc2]: https://github.com/czaku/omnai/releases/tag/v1.0.0-rc2
[v1.0.0-rc1]: https://github.com/czaku/omnai/releases/tag/v1.0.0-rc1
